...
public class ACO {
    ...
    public void run() throws Exception {
        ...
        int threshold = 62; //1.txt 56 62.72 ACHEIVED: 59 
        // int threshold = 1186; //2.txt 1059 1186.08 //TODO NOT ACHEIVED: 1235 1.5p
        ...
        //int threshold = 1927; // 6.txt 1721 1927.52 //TODO NOT ACHEIVED: 2528 0.0p
        ...
        while (iterationCount < maxIterations) {
            ...
            for (Ant ant : ants) {
                ...
                if (antCurrentMakespan < globalShortestLength) {
                    ...
                    // System.out.println("Iteration " + iterationCount + " new global found = " +
                    // antCurrentMakespan);
                }
                if (antCurrentMakespan <= globalShortestLength) {
                    globalShortestLength = antCurrentMakespan;
            ...
            if (globalShortestLength <= threshold && earlyStopping) {
                System.out.println(
                        "Stoppped early at iteration " + iterationCount + " with makespan = " + globalShortestLength);
                break;
            }
        ...
        // globalBestSolution = Arrays.asList(1, 2, 0, 2, 0, 3, 1, 2, 3, 5, 4, 1, 0, 5,
        // 2, 5, 4, 3, 4, 2, 3, 1, 5, 0, 3, 1, 2, 0, 4, 5, 3, 4, 1, 5, 0, 4);
    ...
    public static void updatePheromoneMatrix(List<Integer> bestSolution, int makespan, int globalMakespan, Model model,
            double p) {
